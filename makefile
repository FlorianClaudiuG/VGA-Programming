...
OBJS= kernel_main.o console.o string.o physicalmemorymanager.o virtualmemorymanager.o vm_pde.o vm_pte.o sysapi.o user.o keyboard.o vgamodes.o drawing.o vgacalls.o
